...
<template>
	<main class="md:p-12 p-2">
		<div class="mb-10">
			...
			<p>
				Are you in search of the mystery fruits🍓? You’ve come to the right place🌴.
				All you have to do is select the mystery fruits in the correct order 1️⃣ 2️⃣ 3️⃣.
			</p>
			<p>
				You have 6 attempts before the fruits are lost forever😞. You can check
				the history tab on the left to see details on your previous selections⌛.
			</p>
