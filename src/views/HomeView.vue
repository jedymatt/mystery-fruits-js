...
<template>
  <main class="md:p-12 p-2 relative">
    <div
      :class="`mb-10 bg-red-100 inline-block p-7 border-2 border-red-300 rounded-lg relative ${showInstructions ? '' : 'animate-close-section'} overflow-hidden`"
    >
      <div
    ...
    <div
      v-if="!isGameOver"
      id="game"
      class="grid lg:grid-cols-2 place-items-start justify-items-center content-center gap-4 transition-all duration-200 ease-in"
    >
