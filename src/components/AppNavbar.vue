    ...
    <nav class="text-gray-800">
        <div class="p-2 flex gap-2 items-center">
            ...
            <div class="flex flex-grow items-stretch justify-between">
                <RouterLink to="/credits" class="p-2 rounded-md hover:bg-pink-100">Credits</RouterLink>

                <a class="flex items-center p-2 hover:bg-pink-100 rounded-md gap-1"
                    href="https://www.github.com/jedymatt/mystery-fruits-js" target="_blank" rel="noopener noreferrer">
                    <span class="sr-only">Github</span>
                    <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
